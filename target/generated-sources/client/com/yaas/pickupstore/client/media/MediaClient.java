...
package com.yaas.pickupstore.client.media;
...
import com.yaas.pickupstore.client.media.builder.TenantBuilder;


/**
 * This the entrance point to the Media client.
 * <p>
 * It is a wrapper for a JAX-RS REST client that will call the Media.
 * <p>
...
public class MediaClient
    extends AbstractResourceBuilder<MediaClient>
{
     ...
     * 
     */
    public final static String DEFAULT_BASE_URI = "https://api.stage.yaas.io/hybris/media/v1";
    private final String baseUri;
    private final Client client;

    /**
     * Creates an instance of the {@link MediaClient} for the given URI.
     * 
     * @param baseUri the base URI of the service
     * 
     */
    public MediaClient(final String baseUri) {
     ...
     * 
     */
    public MediaClient(final URI baseUri) {
        this(baseUri.toString(), ClientBuilder.newClient(), new RequestParams());
    }

    /**
     * Creates an instance of the {@link MediaClient} for the given URI, based on the supplied JAX-RS client
     * instance.
     * <p>
     ...
     * 
     */
    public MediaClient(final String baseUri, final Client client) {
        this(baseUri, client, new RequestParams());
    }

    private MediaClient(final String baseUri, final Client client, final RequestParams params) {
    ...
    @Override
    protected MediaClient makeACopy(final RequestParams params) {
        return new MediaClient(baseUri, client, params);
    }
