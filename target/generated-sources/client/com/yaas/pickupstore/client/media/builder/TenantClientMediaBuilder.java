...
/**
 * A {@link com.sap.cloud.yaas.rammler.commons.builder.ResourceBuilder} for the <code>/media</code> resource.
 * 
    ...
    extends AbstractResourceBuilder<TenantClientMediaBuilder>
{
     ...
     * 
     */
    public final static String RELATIVE_URI = "/media";
    /**
    ...
    /**
     * Returns a new {@link com.sap.cloud.yaas.rammler.commons.builder.ResourceBuilder} for the sub-resource located at the relative URI: <code>/{mediaId}</code>.
     * 
        ...
        implements ActionWithPayloadBuilder<TenantClientMediaBuilder.AnyActionBuilder, Object> , HttpActionSettable<TenantClientMediaBuilder.AnyActionBuilder>
    {
        ...
        @Override
        public TenantClientMediaBuilder.AnyActionBuilder fillMethod(com.sap.cloud.yaas.rammler.commons.builder.ActionBuilder.HttpMethod theMethod) {
        ...
        extends TenantClientMediaBuilder.ArbitraryActionBuilder<TenantClientMediaBuilder.GetActionBuilder>
    {
         ...
         * 
         */
        public TenantClientMediaBuilder.GetActionBuilder onBadRequest(ResponseCallback callback) {
         ...
         * 
         */
        public TenantClientMediaBuilder.GetActionBuilder onUnauthorized(ResponseCallback callback) {
         ...
         * 
         */
        public TenantClientMediaBuilder.GetActionBuilder onForbidden(ResponseCallback callback) {
        ...
        implements ActionWithPayloadBuilder<TenantClientMediaBuilder.PostActionBuilder, Object>
    {
         ...
         * 
         */
        public TenantClientMediaBuilder.PostActionBuilder onBadRequest(ResponseCallback callback) {
            return this.withCallbackForCode(400, callback);
        }
         ...
         * 
         */
        public TenantClientMediaBuilder.PostActionBuilder onUnauthorized(ResponseCallback callback) {
            return this.withCallbackForCode(401, callback);
        }
         ...
         * 
         */
        public TenantClientMediaBuilder.PostActionBuilder onForbidden(ResponseCallback callback) {
            return this.withCallbackForCode(403, callback);
        }
