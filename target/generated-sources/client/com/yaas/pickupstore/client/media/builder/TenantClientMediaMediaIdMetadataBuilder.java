...
/**
 * A {@link com.sap.cloud.yaas.rammler.commons.builder.ResourceBuilder} for the <code>/metadata</code> resource.
 * 
    ...
    extends AbstractResourceBuilder<TenantClientMediaMediaIdMetadataBuilder>
{
     ...
     * 
     */
    public final static String RELATIVE_URI = "/metadata";
    /**
        ...
        implements ActionWithPayloadBuilder<TenantClientMediaMediaIdMetadataBuilder.AnyActionBuilder, Object> , HttpActionSettable<TenantClientMediaMediaIdMetadataBuilder.AnyActionBuilder>
    {
        ...
        @Override
        public TenantClientMediaMediaIdMetadataBuilder.AnyActionBuilder fillMethod(com.sap.cloud.yaas.rammler.commons.builder.ActionBuilder.HttpMethod theMethod) {
        ...
        extends TenantClientMediaMediaIdMetadataBuilder.ArbitraryActionBuilder<TenantClientMediaMediaIdMetadataBuilder.GetActionBuilder>
    {
         ...
         * 
         */
        public TenantClientMediaMediaIdMetadataBuilder.GetActionBuilder onBadRequest(ResponseCallback callback) {
         ...
         * 
         */
        public TenantClientMediaMediaIdMetadataBuilder.GetActionBuilder onUnauthorized(ResponseCallback callback) {
         ...
         * 
         */
        public TenantClientMediaMediaIdMetadataBuilder.GetActionBuilder onForbidden(ResponseCallback callback) {
        ...
        implements ActionWithPayloadBuilder<TenantClientMediaMediaIdMetadataBuilder.PutActionBuilder, Object>
    {
         ...
         * 
         */
        public TenantClientMediaMediaIdMetadataBuilder.PutActionBuilder onNotFound(ResponseCallback callback) {
         ...
         * 
         */
        public TenantClientMediaMediaIdMetadataBuilder.PutActionBuilder onBadRequest(ResponseCallback callback) {
            return this.withCallbackForCode(400, callback);
        }
         ...
         * 
         */
        public TenantClientMediaMediaIdMetadataBuilder.PutActionBuilder onUnauthorized(ResponseCallback callback) {
            return this.withCallbackForCode(401, callback);
        }
         ...
         * 
         */
        public TenantClientMediaMediaIdMetadataBuilder.PutActionBuilder onForbidden(ResponseCallback callback) {
            return this.withCallbackForCode(403, callback);
        }
