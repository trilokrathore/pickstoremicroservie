...
package com.yaas.pickupstore.client.document;
...
import com.yaas.pickupstore.client.document.builder.AllBuilder;
import com.yaas.pickupstore.client.document.builder.TenantBuilder;
import com.yaas.pickupstore.client.document.builder.TenantClientAggrBuilder;
import com.yaas.pickupstore.client.document.builder.TenantClientIndexesBuilder;
import com.yaas.pickupstore.client.document.builder.TenantClientTagsBuilder;
    ...
    extends AbstractResourceBuilder<DocumentClient>
{
     ...
     * 
     */
    public final static String DEFAULT_BASE_URI = "https://api.stage.yaas.io/hybris/document/v1";
